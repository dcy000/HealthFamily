...
public class FamilyInputPasswordActivity extends StateBaseActivity implements View.OnClickListener {
    /**  */
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.goto_next) {
            Routerfit.register(LoginRegisterRouterApi.class).skipFamilyInputNameActivity();
        } else {
        }
    }
}
