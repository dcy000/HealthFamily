...
import com.ml.module_shouhuan.adapter.MsgAlreadyDoAdapter;
...
public class MsgAlreadyDoFragment extends StateBaseFragment {
    ...
    private MsgAlreadyDoAdapter mAdapter;
    ...
    public void initView(View view) {
        showSuccess();
        mRecyclerView = view.findViewById(R.id.rv_msg_already_do);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        mRecyclerView.addItemDecoration(new MyItemDecoration());
        mAdapter = new MsgAlreadyDoAdapter(mContext);
