 ...
 * and GC could collect them once BluetoothHandler instance is not referenced any more
 * <p/>
 *
 * @see Handler
 *
...
public class BluetoothHandler {
     ...
     */
    public BluetoothHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public BluetoothHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public BluetoothHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
